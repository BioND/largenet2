		...
		for (node_state_t a = 0; a < states; ++a)
			for (node_state_t b = 0; b < states; ++b)
				for (node_state_t c = 0; c < states; ++c)
					for (node_state_t d = 0; d < states; ++d)
					{
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::RLINE));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::C_IN));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::C_OUT));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::B_IN));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::B_OUT));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::B_IN_C_OUT));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::B_OUT_C_IN));
						m.insert(QuadLineMotif(a, b, c, d, QuadLineMotif::LLINE));
					}
	}
}
